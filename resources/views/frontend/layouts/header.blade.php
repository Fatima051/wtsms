...
<head>
    ...
    <link rel="shortcut icon" type="{{url('frontend/image/x-icon')}}" href="{{url('frontend/img/favicon.png')}}">
    ...
    <link rel="stylesheet" href="{{url('frontend/css/fullcalendar.min.css')}}">
                    ...
                    <li class="navbar-item dropdown header-admin">
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-title">
                                <h5 class="item-title">Farhan Khilji</h5>
                                <span>Admin</span>
                            </div>
                            <div class="admin-img">
                                <img src="{{url('frontend/img/figure/admin.jpg')}}" alt="Admin">
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="item-header">
                                <h6 class="item-title">Farhan Khilji</h6>
                            </div>
        ...
        <div class="dashboard-page-one">
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
               <div class="mobile-sidebar-header d-md-none">
                    <div class="header-logo">
                        <a href="index.html"><img src="{{url('frontend/img/logo1.png')}}" alt="logo"></a>
                    </div>
               </div>
